 ...
 * Database
 *
 * A shared database used in the application
 *
 ******************************************************************************/
...
final class Database {
  ...
  private(set) lazy var persistentContainer: NSPersistentContainer = {
     ...
     */
    let container = NSPersistentContainer(name: "AircallLaurent")
  ...
  func findCall(id: Int, inContext context: NSManagedObjectContext) -> Call? {
    let request: NSFetchRequest<Call> = Call.fetchRequest()
    request.predicate = NSPredicate(format: "id = \(id)")
    // No error check made here for test
