...
[![Documentation](docs/badge.svg)](https://jobertcodes.github.io/aircall-ios-test/solution/LocalPackages/Domain/docs/)

This package contains definitions to the Domain layer, which contains *Entities*, *Use Cases* and *Repository Interfaces*.  
